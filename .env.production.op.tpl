...
# DocuSign OAuth is company-scoped. The production app registration and all
# three managed values live in 1Password; completion of consent still attaches
# the selected provider account only to the current company in Systems.
