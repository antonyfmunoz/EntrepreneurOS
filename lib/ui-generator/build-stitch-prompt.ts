 ...
 * @param componentDirection  Design direction from design system seed (optional, from 03-04)
...
export function buildStitchPrompt(
  ...
  // 11. Component direction from design system seed (optional, from 03-04 pre-generation step)
  if (componentDirection && componentDirection.length > 0) {
    parts.push(componentDirection);
  }
