...
|---:|---|---|---|---|
| 1 | Front-end foundations | Repository-qualified: seven core surfaces; action-first HUD; EA quick requests and work promotion; interactive mission, approval, audit, hierarchy, advisor, Academy, integration, and AI-spend controls; legacy Organization, Chat, Workflow, and Task deep links converge on their governed role-aware EOS surfaces instead of loading quarantined APIs; desktop/mobile acceptance; movable communication FAB; full-width contextual drawer; route-level code splitting | Production signed-in acceptance on supported devices and browsers | Native adaptive workspace for every portfolio/company role and module |
