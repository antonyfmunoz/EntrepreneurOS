...
| 7 | CI/CD and version control | Repository-qualified: audit, checksum migrations, 73 automated tests, browser acceptance, restore, build, container, and a hashed qualification artifact | Protected release branch, required green check, promotion/rollback ownership | Policy-governed native module and contract delivery |
