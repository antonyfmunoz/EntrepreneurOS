...
| Unit and isolated-database integration | Pass | 20 files, 92 tests, no skips against disposable PostgreSQL in local qualification; protected-branch qualification must repeat this result for the exact commit |
