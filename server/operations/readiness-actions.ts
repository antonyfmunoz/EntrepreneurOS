...
export const CONFIGURATION_ACTION_DEFINITIONS: Record<string, ConfigurationActionDefinition> = {
  ...
  paidSaasEnabled: { layer: 14, title: "Paid SaaS release switch", nextAction: "Enable paid SaaS only after live billing, tax, refund, and entitlement acceptance passes." },
  billingConfigured: { layer: 14, title: "Live billing configuration", nextAction: "Configure restricted live Stripe authority, signed webhooks, and server-owned product and price mappings." },
  ...
  nativeEsignPrimaryKmsConfigured: { layer: 3, title: "Primary artifact-plane KMS", nextAction: "Bind the primary artifact plane to the approved production KMS key." },
  ...
  nativeEsignBackupKmsConfigured: { layer: 13, title: "Backup artifact-plane KMS", nextAction: "Bind the backup plane to its approved KMS key." },
