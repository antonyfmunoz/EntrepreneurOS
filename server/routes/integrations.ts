...
import { z } from "zod";
import { eosAuditRecords, eosProviderConnections } from "@shared/schema";
...
async function providerIdentity(provider: SupportedProvider, userId: string): Promise<ProviderIdentity> {
  if (provider === "gmail") {
