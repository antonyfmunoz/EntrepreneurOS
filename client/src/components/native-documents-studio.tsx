...
export function NativeDocumentsStudio({ root, roleScopeKey, canExecute, canDecide }: {
  ...
  const create = useMutation({
    ...
    onSuccess: async (result) => { setSelectedId(result.object.id); await refresh(); },
