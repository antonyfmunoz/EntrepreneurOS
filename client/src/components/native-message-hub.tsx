...
export function NativeMessageHub({ root, seats, canExecute, canDecide }: {
  root: string;
  seats: Seat[];
  canExecute: boolean;
  canDecide: boolean;
  ...
  const refresh = async () => queryClient.invalidateQueries({ queryKey: [root, "native-messages"] });
