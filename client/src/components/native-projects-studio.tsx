...
export function NativeProjectsStudio({ root, roleScopeKey, activeSeatId, seats, processes, canUseWorkflows, canExecute, canDecide }: {
  root: string; roleScopeKey: string; activeSeatId: string; seats: Seat[]; processes: Json[]; canUseWorkflows: boolean; canExecute: boolean; canDecide: boolean;
}) {
