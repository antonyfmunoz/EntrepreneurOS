...
export default function CompanySetupPage() {
  ...
  const missionInput: CompanyMissionInput = {
    ...
    stage, industry, businessModel, offer, targetCustomer, assistantName, founderVision, founderValues, decisionStyle, workingStyle, goals, formation,
  };
  ...
  const validateCurrentMission = useCallback(() => {
    ...
    if (currentStep === 5 && !formation) next.formation = "Choose how this company operates today.";
  ...
  const completeJourney = () => {
    ...
    const founderProfile = { vision: founderVision.trim(), values: founderValues.trim(), decisionStyle: decisionStyle.trim(), workingStyle: workingStyle.trim(), industry: industry.trim(), businessModel, operatingFormation: formation, setupJourneyVersion: "company-mission-journey-v1" };
    saveCompany.mutate({
