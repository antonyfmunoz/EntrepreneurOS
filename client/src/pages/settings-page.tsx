...
import { ExternalLink, Shield, Mail } from "lucide-react";
        ...
        <Tabs defaultValue="general" className="w-full">
          ...
          <TabsContent value="security" className="space-y-4">
            {!isClerkReady && (
              <Alert>
                <AlertDescription>
                  Security features like 2FA, email verification, and password reset require Clerk to be configured. Set VITE_CLERK_PUBLISHABLE_KEY and CLERK_SECRET_KEY in your environment.
                </AlertDescription>
              </Alert>
            )}
              ...
              <CardContent>
                {isClerkReady ? (
                  <p className="text-sm text-muted-foreground">
                    Clerk handles email verification during signup. Your email is verified through your Clerk account.
                  </p>
                ) : (
                  <p className="text-sm text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  2FA is managed through your Clerk account settings
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isClerkReady ? (
                  <p className="text-sm text-muted-foreground">
                    Two-factor authentication can be enabled through your Clerk account. Clerk supports TOTP authenticator apps and SMS verification.
                  </p>
                ) : (
                  <p className="text-sm text-muted-foreground">
                    Two-factor authentication is available when Clerk is configured.
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                {isClerkReady ? (
                  ...
                  <p className="text-sm text-muted-foreground">
                    Password reset via email is available when Clerk is configured.
                  </p>
                )}
              </CardContent>
            </Card>
