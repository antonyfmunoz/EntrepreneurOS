                ...
                <CardContent>
                  ...
                  <div className="mt-4">
                    <div className="relative my-4">
                      ...
                      <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white dark:bg-background px-2 text-gray-500">Social Sign Up</span>
                      </div>
                    </div>
                    ...
                    {!isGoogleSignInAvailable && (
                      <p className="text-xs text-center mt-2 text-gray-500">
                        Firebase configuration is missing. Please set up Firebase API keys to enable Google Sign Up.
                      </p>
                    )}
                  </div>
                </CardContent>
