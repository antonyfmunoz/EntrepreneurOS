...
const valid = {
  ...
  EOS_ARTIFACT_S3_SSE_CUSTOMER_KEY: Buffer.alloc(32, 11).toString("base64"),
  EOS_ARTIFACT_S3_ACCESS_KEY_ID: "primary-access-key-id",
  EOS_ARTIFACT_S3_SECRET_ACCESS_KEY: "primary-secret-access-key-example",
...
describe("production runtime configuration", () => {
  ...
  it("rejects development identity, local storage, weak secrets, and insecure origins", () => {
    expect(productionRuntimeConfigurationIssues({
      ...
      "nativeEsignPrimaryCredentialsConfigured",
      "nativeEsignPrimaryEncryptionConfigured",
