...
try {
  ...
  $runtimeSecretNames = @(
    ...
    "STRIPE_RESTRICTED_KEY", "STRIPE_WEBHOOK_SECRET", "EOS_STRIPE_PLANS", "EOS_RECOVERY_PROVIDER_WEBHOOK_SECRETS",
    ...
    "EOS_ARTIFACT_BACKUP_S3_ACCESS_KEY_ID", "EOS_ARTIFACT_BACKUP_S3_SECRET_ACCESS_KEY", "EOS_MALWARE_SCAN_ENDPOINT",
    "EOS_MALWARE_SCAN_SECRET", "EOS_CANDIDATE_STT_ENABLED", "EOS_CANDIDATE_STT_MODEL", "POSTHOG_API_KEY",
