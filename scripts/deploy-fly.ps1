...
try {
  ...
  flyctl secrets set --app $app --stage `
    ...
    "EOS_ARTIFACT_S3_ENDPOINT=$env:EOS_ARTIFACT_S3_ENDPOINT" `
    "EOS_ARTIFACT_S3_FORCE_PATH_STYLE=$env:EOS_ARTIFACT_S3_FORCE_PATH_STYLE" `
    "EOS_ARTIFACT_S3_PREFIX=$env:EOS_ARTIFACT_S3_PREFIX" `
    "EOS_ARTIFACT_S3_SSE_CUSTOMER_KEY=$env:EOS_ARTIFACT_S3_SSE_CUSTOMER_KEY" `
    ...
    "EOS_ARTIFACT_BACKUP_S3_ENDPOINT=$env:EOS_ARTIFACT_BACKUP_S3_ENDPOINT" `
    "EOS_ARTIFACT_BACKUP_S3_FORCE_PATH_STYLE=$env:EOS_ARTIFACT_BACKUP_S3_FORCE_PATH_STYLE" `
    "EOS_ARTIFACT_BACKUP_S3_PREFIX=$env:EOS_ARTIFACT_BACKUP_S3_PREFIX" `
    "EOS_ARTIFACT_BACKUP_S3_SSE_CUSTOMER_KEY=$env:EOS_ARTIFACT_BACKUP_S3_SSE_CUSTOMER_KEY" `
