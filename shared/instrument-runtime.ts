...
export const eosInstrumentManifest: Record<EosInstrumentKey, {
  ...
  calendar: { label: "Calendar", objectTypes: ["calendar", "event", "availability", "booking", "content_item"], purpose: "Coordinate accountable time, availability, commitments, and the native editorial publishing plan." },
...
export const instrumentActivationRequirements: Partial<Record<EosInstrumentKey, Record<string, readonly string[]>>> = {
  ...
  calendar: {
    calendar: ["timeZone"],
    event: ["startsAt", "endsAt", "participantReferences"],
    availability: ["timeZone", "windows"],
    booking: ["eventObjectId", "bookedByReference"],
    content_item: ["contentType", "channel", "scheduledFor", "editorialState"],
  },
