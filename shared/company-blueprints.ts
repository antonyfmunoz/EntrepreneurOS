...
export const companyBlueprints: readonly CompanyBlueprint[] = [
  {
    ...
    roles: [
      ...
      { key: "growth", title: "Growth & Revenue", kind: "functional_executive", supervisorKey: "company_ceo", agentName: "Growth Agent", mandate: "Create qualified demand and move prospects through a measured commercial pipeline.", tools: ["CRM", "Dialer", "Calendar", "Messages", "Documents", "Analytics"] },
    ...
    starters: [
      commercialStarter("growth", ["CRM", "Dialer", "Calendar", "Messages", "Documents", "Analytics"]),
  ...
  },
  {
    ...
    roles: [
      ...
      { key: "growth", title: "Growth & Revenue", kind: "functional_executive", supervisorKey: "company_ceo", agentName: "Growth Agent", mandate: "Create demand, operate the commercial funnel, and report repeatable revenue evidence.", tools: ["CRM", "Dialer", "Calendar", "Messages", "Analytics", "Campaigns"] },
    ...
    starters: [
      commercialStarter("growth", ["CRM", "Dialer", "Messages", "Calendar", "Analytics"]),
  ...
  },
  {
    ...
    roles: [
      ...
      { key: "brand_growth", title: "Brand & Growth", kind: "functional_executive", supervisorKey: "company_ceo", agentName: "Brand Growth Agent", mandate: "Create qualified demand and learn which customer messages and offers work.", tools: ["CRM", "Dialer", "Content Calendar", "Campaigns", "Analytics", "Documents"] },
    ...
    starters: [
      commercialStarter("brand_growth", ["CRM", "Dialer", "Content Calendar", "Campaigns", "Analytics"]),
  ...
  },
  {
    ...
    roles: [
      ...
      { key: "growth", title: "Growth & Commercial", kind: "functional_executive", supervisorKey: "company_ceo", agentName: "Commercial Agent", mandate: "Build qualified pipeline and learn the repeatable value proposition.", tools: ["CRM", "Dialer", "Calendar", "Messages", "Analytics"] },
    ...
    starters: [
      commercialStarter("growth", ["CRM", "Dialer", "Calendar", "Messages", "Analytics"]),
